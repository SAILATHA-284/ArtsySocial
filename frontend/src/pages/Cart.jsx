...
import Title from "../components/Title"; // Ensure this component exists
import CartTotal from "../components/CartTotal"; // Ensure this component exists
const Cart = () => {
        ...
        {cartData.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              />
              <img onClick={()=>updateQuantity(item._id, 0)}
